...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DkCloudDataModelCustomersCustomerModel', 'model/DkCloudDataModelCustomersItemReciverModel', 'model/DkCloudDataModelSalesSalesOrderLineModel', 'model/DkPlusAPIModelsInvoiceContact', 'model/DkPlusAPIModelsInvoiceReceiver'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DkCloudDataModelCustomersCustomerModel'), require('./DkCloudDataModelCustomersItemReciverModel'), require('./DkCloudDataModelSalesSalesOrderLineModel'), require('./DkPlusAPIModelsInvoiceContact'), require('./DkPlusAPIModelsInvoiceReceiver'));
  } else {
    // Browser globals (root is window)
    if (!root.DkPlusApi) {
      root.DkPlusApi = {};
    }
    root.DkPlusApi.DkPlusAPIModelsOrderHead = factory(root.DkPlusApi.ApiClient, root.DkPlusApi.DkCloudDataModelCustomersCustomerModel, root.DkPlusApi.DkCloudDataModelCustomersItemReciverModel, root.DkPlusApi.DkCloudDataModelSalesSalesOrderLineModel, root.DkPlusApi.DkPlusAPIModelsInvoiceContact, root.DkPlusApi.DkPlusAPIModelsInvoiceReceiver);
  }
}(this, function(ApiClient, DkCloudDataModelCustomersCustomerModel, DkCloudDataModelCustomersItemReciverModel, DkCloudDataModelSalesSalesOrderLineModel, DkPlusAPIModelsInvoiceContact, DkPlusAPIModelsInvoiceReceiver) {
  'use strict';

  /**
   * The DkPlusAPIModelsOrderHead model module.
   * @module model/DkPlusAPIModelsOrderHead
   * @version v1
   */

  /**
   * Constructs a new <code>DkPlusAPIModelsOrderHead</code>.
   * @alias module:model/DkPlusAPIModelsOrderHead
   * @class
  ...
  /**
   * Constructs a <code>DkPlusAPIModelsOrderHead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DkPlusAPIModelsOrderHead} obj Optional instance to populate.
   * @return {module:model/DkPlusAPIModelsOrderHead} The populated <code>DkPlusAPIModelsOrderHead</code> instance.
   */
  ...
  /**
   * @member {module:model/DkPlusAPIModelsOrderHead.StatusEnum} status
   */
  exports.prototype.status = undefined;

  /**
   * @member {module:model/DkPlusAPIModelsOrderHead.DeliveryStatusEnum} deliveryStatus
   */
