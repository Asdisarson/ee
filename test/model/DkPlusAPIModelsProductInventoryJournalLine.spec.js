...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DkPlusAPIModelsProductInventoryJournalLine', function() {
      beforeEach(function() {
        instance = new DkPlusApi.DkPlusAPIModelsProductInventoryJournalLine();
      });

      it('should create an instance of DkPlusAPIModelsProductInventoryJournalLine', function() {
        // TODO: update the code to test DkPlusAPIModelsProductInventoryJournalLine
        expect(instance).to.be.a(DkPlusApi.DkPlusAPIModelsProductInventoryJournalLine);
      });
