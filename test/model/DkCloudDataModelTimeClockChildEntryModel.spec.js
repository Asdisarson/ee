...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DkCloudDataModelTimeClockChildEntryModel', function() {
      beforeEach(function() {
        instance = new DkPlusApi.DkCloudDataModelTimeClockChildEntryModel();
      });

      it('should create an instance of DkCloudDataModelTimeClockChildEntryModel', function() {
        // TODO: update the code to test DkCloudDataModelTimeClockChildEntryModel
        expect(instance).to.be.a(DkPlusApi.DkCloudDataModelTimeClockChildEntryModel);
      });
      ...
      it('should have the property roundedTotalHours (base name: "RoundedTotalHours")', function() {
        // TODO: update the code to test the property roundedTotalHours
        expect(instance).to.have.property('roundedTotalHours');
        // expect(instance.roundedTotalHours).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property roundedActualTotalHours (base name: "RoundedActualTotalHours")', function() {
        // TODO: update the code to test the property roundedActualTotalHours
        expect(instance).to.have.property('roundedActualTotalHours');
        // expect(instance.roundedActualTotalHours).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property roundedTotalMinutes (base name: "RoundedTotalMinutes")', function() {
        // TODO: update the code to test the property roundedTotalMinutes
        expect(instance).to.have.property('roundedTotalMinutes');
        // expect(instance.roundedTotalMinutes).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property actualRoundedTotalMinutes (base name: "ActualRoundedTotalMinutes")', function() {
        // TODO: update the code to test the property actualRoundedTotalMinutes
        expect(instance).to.have.property('actualRoundedTotalMinutes');
        // expect(instance.actualRoundedTotalMinutes).to.be(expectedValueLiteral);
      });
