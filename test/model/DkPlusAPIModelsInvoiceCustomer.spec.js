...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DkPlusAPIModelsInvoiceCustomer', function() {
      beforeEach(function() {
        instance = new DkPlusApi.DkPlusAPIModelsInvoiceCustomer();
      });

      it('should create an instance of DkPlusAPIModelsInvoiceCustomer', function() {
        // TODO: update the code to test DkPlusAPIModelsInvoiceCustomer
        expect(instance).to.be.a(DkPlusApi.DkPlusAPIModelsInvoiceCustomer);
      });
