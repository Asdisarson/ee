...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DkCloudDataModelSalesSalesOrderModel', function() {
      beforeEach(function() {
        instance = new DkPlusApi.DkCloudDataModelSalesSalesOrderModel();
      });

      it('should create an instance of DkCloudDataModelSalesSalesOrderModel', function() {
        // TODO: update the code to test DkCloudDataModelSalesSalesOrderModel
        expect(instance).to.be.a(DkPlusApi.DkCloudDataModelSalesSalesOrderModel);
      });
