...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DkPlusAPIModelsPurchaseHead', function() {
      beforeEach(function() {
        instance = new DkPlusApi.DkPlusAPIModelsPurchaseHead();
      });

      it('should create an instance of DkPlusAPIModelsPurchaseHead', function() {
        // TODO: update the code to test DkPlusAPIModelsPurchaseHead
        expect(instance).to.be.a(DkPlusApi.DkPlusAPIModelsPurchaseHead);
      });
