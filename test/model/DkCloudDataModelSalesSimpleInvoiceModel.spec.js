...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DkCloudDataModelSalesSimpleInvoiceModel', function() {
      beforeEach(function() {
        instance = new DkPlusApi.DkCloudDataModelSalesSimpleInvoiceModel();
      });

      it('should create an instance of DkCloudDataModelSalesSimpleInvoiceModel', function() {
        // TODO: update the code to test DkCloudDataModelSalesSimpleInvoiceModel
        expect(instance).to.be.a(DkPlusApi.DkCloudDataModelSalesSimpleInvoiceModel);
      });
