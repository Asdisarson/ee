...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VLinkDkSoftwareDkSOAPTOrderLine', function() {
      beforeEach(function() {
        instance = new DkPlusApi.VLinkDkSoftwareDkSOAPTOrderLine();
      });

      it('should create an instance of VLinkDkSoftwareDkSOAPTOrderLine', function() {
        // TODO: update the code to test VLinkDkSoftwareDkSOAPTOrderLine
        expect(instance).to.be.a(DkPlusApi.VLinkDkSoftwareDkSOAPTOrderLine);
      });
      ...
      it('should have the property skipOrderLineInCreate (base name: "SkipOrderLineInCreate")', function() {
        // TODO: update the code to test the property skipOrderLineInCreate
        expect(instance).to.have.property('skipOrderLineInCreate');
        // expect(instance.skipOrderLineInCreate).to.be(expectedValueLiteral);
      });

      it('should have the property createdSalesOrderQuantity (base name: "CreatedSalesOrderQuantity")', function() {
        // TODO: update the code to test the property createdSalesOrderQuantity
        expect(instance).to.have.property('createdSalesOrderQuantity');
        // expect(instance.createdSalesOrderQuantity).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property useCustomerItemCode (base name: "UseCustomerItemCode")', function() {
        // TODO: update the code to test the property useCustomerItemCode
        expect(instance).to.have.property('useCustomerItemCode');
        // expect(instance.useCustomerItemCode).to.be(expectedValueLiteral);
      });
