...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DkCloudDataModelVendorsVendorDimmentions', function() {
      beforeEach(function() {
        instance = new DkPlusApi.DkCloudDataModelVendorsVendorDimmentions();
      });

      it('should create an instance of DkCloudDataModelVendorsVendorDimmentions', function() {
        // TODO: update the code to test DkCloudDataModelVendorsVendorDimmentions
        expect(instance).to.be.a(DkPlusApi.DkCloudDataModelVendorsVendorDimmentions);
      });
