...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DkCloudDataModelVendorsVendorMemoModel', function() {
      beforeEach(function() {
        instance = new DkPlusApi.DkCloudDataModelVendorsVendorMemoModel();
      });

      it('should create an instance of DkCloudDataModelVendorsVendorMemoModel', function() {
        // TODO: update the code to test DkCloudDataModelVendorsVendorMemoModel
        expect(instance).to.be.a(DkPlusApi.DkCloudDataModelVendorsVendorMemoModel);
      });
