...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VLinkDkSoftwareDkSOAPTCustomerProperty', function() {
      beforeEach(function() {
        instance = new DkPlusApi.VLinkDkSoftwareDkSOAPTCustomerProperty();
      });

      it('should create an instance of VLinkDkSoftwareDkSOAPTCustomerProperty', function() {
        // TODO: update the code to test VLinkDkSoftwareDkSOAPTCustomerProperty
        expect(instance).to.be.a(DkPlusApi.VLinkDkSoftwareDkSOAPTCustomerProperty);
      });
