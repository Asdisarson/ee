...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VLinkDkSoftwareDkSOAPTItemReceiver', function() {
      beforeEach(function() {
        instance = new DkPlusApi.VLinkDkSoftwareDkSOAPTItemReceiver();
      });

      it('should create an instance of VLinkDkSoftwareDkSOAPTItemReceiver', function() {
        // TODO: update the code to test VLinkDkSoftwareDkSOAPTItemReceiver
        expect(instance).to.be.a(DkPlusApi.VLinkDkSoftwareDkSOAPTItemReceiver);
      });
