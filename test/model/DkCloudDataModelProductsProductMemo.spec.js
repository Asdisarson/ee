...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DkCloudDataModelProductsProductMemo', function() {
      beforeEach(function() {
        instance = new DkPlusApi.DkCloudDataModelProductsProductMemo();
      });

      it('should create an instance of DkCloudDataModelProductsProductMemo', function() {
        // TODO: update the code to test DkCloudDataModelProductsProductMemo
        expect(instance).to.be.a(DkPlusApi.DkCloudDataModelProductsProductMemo);
      });
