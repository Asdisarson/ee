...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VLinkDkSoftwareDkSOAPTCreditCard', function() {
      beforeEach(function() {
        instance = new DkPlusApi.VLinkDkSoftwareDkSOAPTCreditCard();
      });

      it('should create an instance of VLinkDkSoftwareDkSOAPTCreditCard', function() {
        // TODO: update the code to test VLinkDkSoftwareDkSOAPTCreditCard
        expect(instance).to.be.a(DkPlusApi.VLinkDkSoftwareDkSOAPTCreditCard);
      });
