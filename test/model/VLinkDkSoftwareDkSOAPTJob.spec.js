...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VLinkDkSoftwareDkSOAPTJob', function() {
      beforeEach(function() {
        instance = new DkPlusApi.VLinkDkSoftwareDkSOAPTJob();
      });

      it('should create an instance of VLinkDkSoftwareDkSOAPTJob', function() {
        // TODO: update the code to test VLinkDkSoftwareDkSOAPTJob
        expect(instance).to.be.a(DkPlusApi.VLinkDkSoftwareDkSOAPTJob);
      });
