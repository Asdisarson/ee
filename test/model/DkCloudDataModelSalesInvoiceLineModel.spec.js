...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DkCloudDataModelSalesInvoiceLineModel', function() {
      beforeEach(function() {
        instance = new DkPlusApi.DkCloudDataModelSalesInvoiceLineModel();
      });

      it('should create an instance of DkCloudDataModelSalesInvoiceLineModel', function() {
        // TODO: update the code to test DkCloudDataModelSalesInvoiceLineModel
        expect(instance).to.be.a(DkPlusApi.DkCloudDataModelSalesInvoiceLineModel);
      });
      ...
      it('should have the property discountAmountWithTax (base name: "DiscountAmountWithTax")', function() {
        // TODO: update the code to test the property discountAmountWithTax
        expect(instance).to.have.property('discountAmountWithTax');
        // expect(instance.discountAmountWithTax).to.be(expectedValueLiteral);
      });
