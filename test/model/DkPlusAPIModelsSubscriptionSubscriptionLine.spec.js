...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DkPlusAPIModelsSubscriptionSubscriptionLine', function() {
      beforeEach(function() {
        instance = new DkPlusApi.DkPlusAPIModelsSubscriptionSubscriptionLine();
      });

      it('should create an instance of DkPlusAPIModelsSubscriptionSubscriptionLine', function() {
        // TODO: update the code to test DkPlusAPIModelsSubscriptionSubscriptionLine
        expect(instance).to.be.a(DkPlusApi.DkPlusAPIModelsSubscriptionSubscriptionLine);
      });
