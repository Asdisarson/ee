...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DkCloudDataModelCustomersContactModel', function() {
      beforeEach(function() {
        instance = new DkPlusApi.DkCloudDataModelCustomersContactModel();
      });

      it('should create an instance of DkCloudDataModelCustomersContactModel', function() {
        // TODO: update the code to test DkCloudDataModelCustomersContactModel
        expect(instance).to.be.a(DkPlusApi.DkCloudDataModelCustomersContactModel);
      });
