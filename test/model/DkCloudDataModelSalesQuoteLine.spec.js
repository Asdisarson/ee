...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DkCloudDataModelSalesQuoteLine', function() {
      beforeEach(function() {
        instance = new DkPlusApi.DkCloudDataModelSalesQuoteLine();
      });

      it('should create an instance of DkCloudDataModelSalesQuoteLine', function() {
        // TODO: update the code to test DkCloudDataModelSalesQuoteLine
        expect(instance).to.be.a(DkPlusApi.DkCloudDataModelSalesQuoteLine);
      });
